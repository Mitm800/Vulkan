...
namespace lve {
	...
	void LveModel::createIndexBuffers(const std::vector<uint32_t>& indices) {
		...
		LveBuffer stagingBuffer{lveDevice, indexCount, indexSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, };
